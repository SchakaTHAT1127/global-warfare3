        ...
        if IsValid(ent) then
            ...
            if distance < 300 then
                ...
                if screenData.visible then
                    ...
                    draw.SimpleText("U.S.S.R Logistics Crate", "TargetID", x, y, Color(255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
                    draw.RoundedBox(4, x-90, y+23, 180, 25, Color(216,87,61,150))
