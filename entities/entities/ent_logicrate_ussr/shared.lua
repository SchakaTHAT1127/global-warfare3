...
ENT.PrintName = "logistics crate but rus" -- The name that will appear in the spawn menu.
ENT.Author = "Alp Er Tunga" -- The author's name for this Entity.
ENT.Category = "red flood entities" -- The category for this Entity in the spawn menu.
ENT.Purpose = "logistics crate" -- The purpose of this Entity.
